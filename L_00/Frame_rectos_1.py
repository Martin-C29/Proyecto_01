...
Label(miFrame2, text="Problema 9",fg="black", font=("Serif", 18)).place(x=20,y=250)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=50,y=300)
Label(miFrame2, text="Problema 10",fg="black", font=("Serif", 18)).place(x=200,y=250)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=250,y=300)
Label(miFrame2, text="Problema 11",fg="black", font=("Serif", 18)).place(x=400,y=250)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=450,y=300)
Label(miFrame2, text="Problema 12",fg="black", font=("Serif", 18)).place(x=600,y=250)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=650,y=300)
Label(miFrame2, text="Problema 13",fg="black", font=("Serif", 18)).place(x=20,y=450)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=50,y=500)
Label(miFrame2, text="Problema 14",fg="black", font=("Serif", 18)).place(x=200,y=450)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=250,y=500)
Label(miFrame2, text="Problema 15",fg="black", font=("Serif", 18)).place(x=400,y=450)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=450,y=500)
Label(miFrame2, text="Problema 16",fg="black", font=("Serif", 18)).place(x=600,y=450)
Boton=tk.Button(text="Clic aqui")
