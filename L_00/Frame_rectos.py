...
Label(miFrame2, text="Problema 1",fg="black", font=("Serif", 18)).place(x=20,y=250)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=50,y=300)
Label(miFrame2, text="Problema 2",fg="black", font=("Serif", 18)).place(x=200,y=250)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=250,y=300)
Label(miFrame2, text="Problema 3",fg="black", font=("Serif", 18)).place(x=400,y=250)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=450,y=300)
Label(miFrame2, text="Problema 4",fg="black", font=("Serif", 18)).place(x=600,y=250)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=650,y=300)
Label(miFrame2, text="Problema 5",fg="black", font=("Serif", 18)).place(x=20,y=450)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=50,y=500)
Label(miFrame2, text="Problema 6",fg="black", font=("Serif", 18)).place(x=200,y=450)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=250,y=500)
Label(miFrame2, text="Problema 7",fg="black", font=("Serif", 18)).place(x=400,y=450)
Boton=tk.Button(text="Clic aqui")
Boton.place(x=450,y=500)
Label(miFrame2, text="Problema 8",fg="black", font=("Serif", 18)).place(x=600,y=450)
Boton=tk.Button(text="Clic aqui")
