...
Label(miFrame2, text="Engrane Helicoidal",fg="black", font=("Serif", 22)).place(x=220,y=150)
Label(miFrame2, text="Problema 21",fg="black", font=("Serif", 18)).place(x=20,y=250)
